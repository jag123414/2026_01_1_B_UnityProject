...
public class DraggableRank : MonoBehaviour
{
    ...
    public Vector3 dragOffset;                    // 드래그시 오프셋 (보정 값)
    ...
    void StopDragging()    // 드래그 종료
    {
        ...
        GridCell targetCell = GameManager.emptyCell(transform.position);    // 가장 가까운 칸 찾기
        ...
        if (targetCell != null)
        {
            ...
            else if (targetCell.currentRank != this && targetCell.currentRank.rankLevel == rankLevel)    // 같은 랭크일 경우 합치기
            {
